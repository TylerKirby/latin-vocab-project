...
class Analysis:
    ...
    def author_readability(self, lexicon_size) -> pd.DataFrame:
        """
        Compute percent of unique lemmata known and percent of total words known for all authors for a given lexicon.
        size.
        :param lexicon_size:
        :return:
        """
    ...
    def author_readability_sampling(self, lexicon_size, n_samples, sample_size):
        """
        Compute empirical mean and standard deviation of percent known unique words and percent total unique words for
        a given lexicon.
        :param lexicon_size:
        :return:
        """
        ...
        for p in self.author_table_paths:
            ...
            # Stats
            author_readability_sampling[author] = [
                page_known_lemmata.mean(),
                page_known_lemmata.std(),
                page_known_words.mean(),
                page_known_words.std(),
            ]
        author_readability_sampling_df = pd.DataFrame.from_dict(
            author_readability_sampling,
            orient="index",
            columns=[
        ...
        return author_readability_sampling_df
